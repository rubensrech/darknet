...
diff <(sed '/Loading weights.*/d' stderr.txt) <(sed '/Loading weights.*/d' ${APP_DIR}/golden_stderr.txt) > stderr_diff.log
...
python ${APP_DIR}/check_detections_error.py ${APP_DIR}/golden_stdout.txt stdout.txt > special_check.log